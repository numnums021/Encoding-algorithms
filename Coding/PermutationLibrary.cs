...
namespace Кодирование
{
    ...
    class PermutationLibrary
    {
        ...
        public readonly Permutation finalPermutation;
        ...
        public PermutationLibrary()
        {
            ...
            Permutation p2 = new Permutation(s2);
            Permutation p3 = new Permutation(s3);
            Permutation p4 = new Permutation(s4);
            Permutation p5 = new Permutation(s5);
            Permutation p6 = new Permutation(s6);
            Permutation p7 = new Permutation(s7);
            ...
            this.finalPermutation = new Permutation(f);
        }
    }
}
